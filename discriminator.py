...
def create_discriminator(inp_tensor):
    with tf.name_scope('discriminator'):
        ...
        prev_l = GRU(48, return_sequences=True, stateful=True, kernel_initializer=RandomNormal(mean=0, stddev=0.5))(prev_l)
        prev_l = LeakyReLU(alpha=0.2)(prev_l)
        prev_l = GRU(36, stateful=True, kernel_initializer=RandomNormal(mean=0, stddev=0.5))(prev_l)
        prev_l = LeakyReLU(alpha=0.2)(prev_l)
