...
def create_generator(inp_tensor):
    with tf.name_scope('generator'):
        ...
        prev_l = LSTM(72, stateful=True, kernel_initializer=RandomNormal(mean=0, stddev=0.02), activation='relu')(prev_l)
        prev_l = Dense(72, kernel_constraint=maxnorm(4), kernel_initializer=RandomNormal(mean=0, stddev=0.02), activation='relu')(prev_l)
